...
class ApplicationToken {
  ...
  Future<void> saveToken(String token, String userId) async {
    ...
    await _storage.write(key: 'tokenAdmin', value: token);
    await _storage.write(key: 'userIdAdmin', value: userId);
  }
  ...
  Future<void> deleteToken() async {
    ...
    await _storage.delete(key: 'tokenAdmin');
    await _storage.delete(key: 'userIdAdmin');
  }

  Future<void> bootUp() async {
    _token = await _storage.read(key: 'tokenAdmin');
    _userId = await _storage.read(key: 'userIdAdmin');
