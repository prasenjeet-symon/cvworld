        ...
        <section id="resume" class="resume" style="font-family: 'Rubik', sans-serif; width: 210mm; min-height: 297mm; margin: 0 auto; background-color: white;">
          <div style="padding: 15px; background-color: #303846; color: white;height: 70px;">
            ...
            <div style="display: flex; align-items: center; margin-top: 10px">
              ...
              <div style="display: ${resume.details.phone ? 'flex':'none'}; align-items: flex-start; font-size: 0.8rem; padding: 5px; margin-right: 20px">
                <span class="material-symbols-outlined" style="margin-right: 10px; font-size: 0.9rem"> phone </span> ${resume.details.phone}
              </div>
              <div style="display: ${resume.details.address ? 'flex': 'none'}; align-items: flex-start; font-size: 0.8rem; padding: 5px; margin-right: 20px">
          ...
          <div style="background-color: white; padding: 10px; display: flex; align-items: flex-start">
