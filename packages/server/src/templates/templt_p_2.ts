    ...
    >
      ...
      <div style="flex: 2.5; background-color: #f8f5f9; height: 100%">
        ...
        <div style="padding: 10px; margin-bottom: 15px; display: ${resume.details.placeOfBirth || resume.details.dateOfBirth ? 'block' : 'none'}">
          ...
          <div style="display: ${resume.details.dateOfBirth ? 'flex' : 'none'}; align-items: flex-start; font-size: 0.8rem; padding: 5px 5px 0px 5px; margin-bottom: 0px">${formatDate(resume.details.dateOfBirth)}</div>
